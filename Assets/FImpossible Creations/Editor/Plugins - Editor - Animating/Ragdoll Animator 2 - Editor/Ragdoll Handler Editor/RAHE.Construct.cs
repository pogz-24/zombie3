            ...
            else
            {
                ...
                else
                {
                    ...
                    else if (handler._Editor_ChainCategory == EBoneChainCategory.Colliders) // Constructor Category Colliders
                    {
                        ...
                        EditorGUILayout.BeginHorizontal();
                        GUILayout.Space(20);
                        RagdollHandler.AutoScaleHandles = EditorGUILayout.Toggle(new GUIContent("Auto Scale Handles:", "If you experience issues with colliders handles display size on the scene view, try disabling this option"), RagdollHandler.AutoScaleHandles);
                        GUILayout.Space(20);
                        EditorGUILayout.EndHorizontal();
                        //GUILayout.Space( -10 );
                    }
